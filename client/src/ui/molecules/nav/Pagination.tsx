...
export const Pagination = ({ currentPage, hasNextPage, hasPreviousPage, totalPages }: Props) => {
	...
	return (
		<nav
			...
			className="flex items-center justify-between border-t border-neutral-200 px-4 sm:px-0 my-4 sm:my-10"
		>
