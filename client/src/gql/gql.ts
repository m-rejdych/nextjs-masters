...
const documents = {
    ...
    "query ProductGetProductById($id: ID!) {\n  productById(id: $id) {\n    ...Product\n  }\n}": types.ProductGetProductByIdDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ProductGetProductById($id: ID!) {\n  productById(id: $id) {\n    ...Product\n  }\n}"): typeof import('./graphql').ProductGetProductByIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
